...
namespace FileClassifier
{
    static class Program
    {
        ...
        {
            String shortcutPath = String.Format("{0}\\FileClassifier.lnk", Environment.GetFolderPath(Environment.SpecialFolder.SendTo));
        ...
        static void Main(string[] args)
        {
            ...
            var frmPrincipal = new FrmFileClassifier();
            if (args.Count() > 0)
            {
                String path = args[0];
